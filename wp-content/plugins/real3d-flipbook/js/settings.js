(function($) {
    ...
    $(document).ready(function() {
        ...
        addOption( 
            ...
            "dropdown", 
            "Rewrite slug",
            "Remove post type slug from flipbook permalink. After changing this setting, go to WordPress admin area > Settings > Permalinks and click Click 'Save Changes'",
            ["Disabled", "Enabled"]
        );
        ...
        addOption(
            ...
            'text',
            'Image quality',
            'JPG quality, default 0.8 <br/> 0.9 - very high-quality image with significant reduction on the originalfile size <br/>0.8 - greater file size reduction with almost no loss in quality <br/> 0.75 and lower - begins to show obvious differences in the image'
        )
        ...
        addOption( 
            ...
            'checkbox',
            'PDF Text layer',
            'Include PDF text layer in flipbook - used for text search and text selection'
        )
